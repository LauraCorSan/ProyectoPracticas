...
export class RegistroComponent {
  createUser(): boolean {
    ...
    const intolerances = Array.from(intolerancesElement.selectedOptions).map(option => ({ name: option.value }));
    ...
    const birthDateInput = document.getElementById('birth') as HTMLInputElement;
    const birthDateISO = birthDateInput.value;
